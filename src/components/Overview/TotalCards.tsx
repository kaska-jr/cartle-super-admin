  ...
  const Cards = [
    {
      ...
      icon: (
        ...
        >
          ...
          <path
            opacity="0.4"
            d="M27.3499 13.66L21.0599 10.27C20.3999 9.91 19.5999 9.91 18.9299 10.27L12.6399 13.66C12.1799 13.91 11.8999 14.4 11.8999 14.94C11.8999 15.48 12.1799 15.97 12.6399 16.22L18.9299 19.61C19.2599 19.79 19.6299 19.88 19.9899 19.88C20.3499 19.88 20.7199 19.79 21.0499 19.61L27.3399 16.22C27.7999 15.97 28.0799 15.48 28.0799 14.94C28.0999 14.4 27.8099 13.91 27.3499 13.66Z"
            fill="rgb(249, 115, 22, 1.0)"
          />
          <path
            opacity="0.4"
            d="M17.9002 20.79L12.0502 17.86C11.6002 17.63 11.0802 17.66 10.6502 17.92C10.2202 18.18 9.97021 18.64 9.97021 19.14V24.67C9.97021 25.63 10.5002 26.49 11.3602 26.92L17.2102 29.8401C17.4102 29.9401 17.6302 29.99 17.8502 29.99C18.1102 29.99 18.3702 29.92 18.6002 29.77C19.0302 29.51 19.2802 29.05 19.2802 28.55V23.02C19.2902 22.08 18.7602 21.22 17.9002 20.79Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            opacity="0.4"
            d="M30.03 19.15V23.74C30.02 23.73 30.01 23.71 30 23.7C30 23.69 29.99 23.68 29.98 23.67C29.94 23.61 29.89 23.55 29.84 23.5C29.83 23.49 29.82 23.47 29.81 23.46C29 22.56 27.81 22 26.5 22C25.24 22 24.09 22.52 23.27 23.36C22.48 24.17 22 25.28 22 26.5C22 27.34 22.24 28.14 22.65 28.82C22.82 29.11 23.03 29.37 23.26 29.61L22.79 29.85C22.59 29.95 22.37 30 22.15 30C21.89 30 21.63 29.93 21.39 29.78C20.97 29.52 20.71 29.06 20.71 28.56V23.04C20.71 22.08 21.24 21.22 22.1 20.79L27.95 17.87C28.4 17.64 28.92 17.66 29.35 17.93C29.77 18.19 30.03 18.65 30.03 19.15Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            d="M29.98 23.67C29.16 22.66 27.91 22.02 26.5 22.02C25.44 22.02 24.46 22.39 23.69 23.01C22.65 23.83 22 25.1 22 26.52C22 27.36 22.24 28.16 22.65 28.84C22.92 29.29 23.26 29.68 23.66 30H23.67C24.44 30.64 25.43 31.02 26.5 31.02C27.64 31.02 28.67 30.6 29.46 29.9C29.81 29.6 30.11 29.24 30.35 28.84C30.76 28.16 31 27.36 31 26.52C31 25.44 30.62 24.44 29.98 23.67ZM28.76 25.96L26.36 28.18C26.22 28.31 26.03 28.38 25.85 28.38C25.66 28.38 25.47 28.31 25.32 28.16L24.21 27.05C23.92 26.76 23.92 26.28 24.21 25.99C24.5 25.7 24.98 25.7 25.27 25.99L25.87 26.59L27.74 24.86C28.04 24.58 28.52 24.6 28.8 24.9C29.09 25.21 29.07 25.68 28.76 25.96Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
        </svg>
      ),
      percentage: 23.5,
      value: merchantCount || 0,
      progress: "increase",
    },
    {
      text: "Total Revenue",
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          />
          <path
            d="M24.25 30.5C25.2165 30.5 26 29.7165 26 28.75C26 27.7835 25.2165 27 24.25 27C23.2835 27 22.5 27.7835 22.5 28.75C22.5 29.7165 23.2835 30.5 24.25 30.5Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            d="M16.25 30.5C17.2165 30.5 18 29.7165 18 28.75C18 27.7835 17.2165 27 16.25 27C15.2835 27 14.5 27.7835 14.5 28.75C14.5 29.7165 15.2835 30.5 16.25 30.5Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            opacity="0.4"
            d="M12.84 11.94L12.64 14.39C12.6 14.86 12.97 15.25 13.44 15.25H28.75C29.17 15.25 29.52 14.93 29.55 14.51C29.68 12.74 28.33 11.3 26.56 11.3H14.29C14.19 10.86 13.99 10.44 13.68 10.09C13.19 9.56 12.49 9.25 11.77 9.25H10C9.59 9.25 9.25 9.59 9.25 10C9.25 10.41 9.59 10.75 10 10.75H11.74C12.05 10.75 12.34 10.88 12.55 11.1C12.76 11.33 12.86 11.63 12.84 11.94Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            d="M28.5101 16.75H13.1701C12.7501 16.75 12.4101 17.07 12.3701 17.48L12.0101 21.83C11.8701 23.53 13.2101 25 14.9201 25H26.0401C27.5401 25 28.8601 23.77 28.9701 22.27L29.3001 17.6C29.3401 17.14 28.9801 16.75 28.5101 16.75Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <path
            opacity="0.4"
            d="M17.99 25.98C22.4028 25.98 25.98 22.4028 25.98 17.99C25.98 13.5772 22.4028 10 17.99 10C13.5772 10 10 13.5772 10 17.99C10 22.4028 13.5772 25.98 17.99 25.98Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            d="M29.9701 23.99C29.9701 27.29 27.2901 29.97 23.9901 29.97C21.9501 29.97 20.1601 28.95 19.0801 27.4C23.4401 26.91 26.9101 23.44 27.4001 19.08C28.9501 20.16 29.9701 21.95 29.9701 23.99Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
          <path
            d="M19.45 17.71L17.05 16.87C16.81 16.79 16.76 16.77 16.76 16.42C16.76 16.16 16.94 15.95 17.17 15.95H18.67C18.99 15.95 19.25 16.24 19.25 16.6C19.25 17.01 19.59 17.35 20 17.35C20.41 17.35 20.75 17.01 20.75 16.6C20.75 15.45 19.86 14.51 18.75 14.46V14.41C18.75 14 18.41 13.66 18 13.66C17.59 13.66 17.25 13.99 17.25 14.41V14.46H17.16C16.11 14.46 15.25 15.34 15.25 16.43C15.25 17.38 15.67 17.99 16.54 18.29L18.95 19.13C19.19 19.21 19.24 19.23 19.24 19.58C19.24 19.84 19.06 20.05 18.83 20.05H17.33C17.01 20.05 16.75 19.76 16.75 19.4C16.75 18.99 16.41 18.65 16 18.65C15.59 18.65 15.25 18.99 15.25 19.4C15.25 20.55 16.14 21.49 17.25 21.54V21.6C17.25 22.01 17.59 22.35 18 22.35C18.41 22.35 18.75 22.01 18.75 21.6V21.55H18.84C19.89 21.55 20.75 20.67 20.75 19.58C20.75 18.63 20.32 18.02 19.45 17.71Z"
            fill="rgb(249, 115, 22, 0.80)"
          />
        </svg>
      ),
    ...
    <div className="grid gap-4 lg:col-span-5 xl:gap-8 sm:mr-2 mr-3">
      <div className="grid md:grid-cols-2 gap-4 xl:gap-8">
        {Cards.map((item, index) => (
          <div
            key={index}
            className="bg-slate-900 p-4 rounded-[0.875rem]  grid gap-[0.625rem] cards text-gray-800 dark:bg-slate-900 dark:text-gray-200 dark:border-0"
          >
            ...
            <h3 className="text-gray-300 font-medium leading-[1.625rem] text-lg dark:text-gray-300">
              {item.text}
            </h3>
            <p className="font-semibold text-gray-300 text-2xl leading-8 dark:text-gray-300">
              {item.text === "Total Revenue" ? `$${item.value}` : item.value}
            </p>
            <div className="flex items-center justify-between gap-4">
              <p
                className={`text-xs leading-4 font-medium ${
                  item.progress === "increase"
                    ? "text-[#34caa5] bg-[rgba(52,202,165,0.12)]"
                    : "text-[#ed544e] bg-[rgba(237,84,78,0.12)]"
                } py-1 px-2 rounded-[62.5rem] flex items-center gap-1`}
              >
                {item.progress === "increase" ? (
                  <>
                    <svg
              ...
              <p className="text-gray-300 text-sm dark:text-gray-300">
                vs. previous month
              </p>
            </div>
          </div>
