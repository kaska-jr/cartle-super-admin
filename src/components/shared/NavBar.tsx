...
import CartleLogo from "../../assets/images/cartle-logo.png";
...
const Navbar = () => {
  ...
  const formattedDate: string = getCurrentDateFormatted();

  const notifications = [
    { title: "Welcome! Samuel 😄", text: "Lorem ipsum dolor sit amet." },
    {
      title: "Referal Bonus arrived! 🎁",
      text: "Consectetur adipiscing elit.",
    },
    { title: "New purchased order 🚀", text: "Consectetur adipiscing elit." },
  ];

  return (
    <header className="bg-background w-full py-2 lg:py-4  px-6 bg-slate-900 dark:bg-slate-900 dark:border-gray-700 absolute mx-auto z-50 ">
      <div className="flex items-center justify-between mx-auto w-full">
        <span className="flex items-center gap-4">
          <img
            ...
            alt="Logo"
          />
          <h1 className="text-lg md:text-2xl sm:text-xl font-semibold md:block text-white">
            Super Admin
          </h1>
        </span>

        {/**shows on mobile */}
        <div className="md:hidden flex items-center text-gray-400 dark:text-gray-400">
          <NotificationPopover
            buttonContent={
              <svg
        ...
        <div className="hidden md:flex items-center space-x-4">
          <div className="flex items-center space-x-3">
            <div className="relative">
              <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                <svg
                  className="w-4 h-4 stroke-gray-400 dark:stroke-gray-400"
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
              ...
              <input
                type="search"
                id="default-search"
                className="outline-none  block w-full px-4 py-2  pl-2 ps-10 text-sm text-white border border-gray-400 rounded-full focus:ring-orange-500 focus:border-orange-500  dark:border-gray-400 dark:placeholder-white  dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500 bg-transparent"
                placeholder="Search......"
                required
              />
            </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              <path
                ...
                className="stroke-gray-200 dark:stroke-gray-200"
              />
              <path
              ...
              <path
                ...
                fill="black"
                className="fill-gray-200 dark:fill-gray-200"
              />
            </svg>
          ...
          <div className="text-gray-400 dark:text-gray-400">
            <ProfileMenu
              name="Cartle Technologies"
              email="cartletech@gmail.com"
            >
              <img className="w-8 h-8" src={Avatar} alt="Avatar" />
            </ProfileMenu>
          </div>
      ...
      <Transition show={menuOpen}>
        ...
        ></div>
        <div className="md:hidden fixed inset-y-0 right-0 w-64 bg-white dark:bg-gray-400 shadow-lg z-50">
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="outline-none block w-full p-4 py-3 pl-2 ps-10 text-sm text-gray-400 border border-gray-300 rounded-full bg-gray-50 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                  placeholder="Search..."
                  required
                />
              </div>
